        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              نحن ملتزمون بتوفير أعلى جودة من المكملات الغذائية لمساعدتك على
              تحقيق أهدافك في اللياقة البدنية. منتجاتنا مصممة علمياً، مختبرة
              معملياً، وموثوقة من قبل الرياضيين حول العالم.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-around items-center gap-3">
            <Card className="text-center bg-gradient-card border-border hover:shadow-glow transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground">
                  مكونات مختبرة معملياً من موردين موثوقين
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center bg-gradient-card border-border hover:shadow-glow transition-all duration-300">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground">
                  معالجة سريعة وشحن موثوق في جميع أنحاء العالم
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center bg-gradient-card border-border hover:shadow-glow transition-all duration-300 w-full lg:w-auto">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground">
                  آلاف العملاء الراضين وقصص النجاح
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              اكتشف أشهر مكملاتنا، مختارة بعناية لمساعدتك على تحقيق أهدافك في
              اللياقة البدنية.
            </p>
          </div>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              نتائج حقيقية من أشخاص حقيقيين يثقون في فيت سابس لرحلة اللياقة
              البدنية.
            </p>
          </div>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="flex mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="h-5 w-5 fill-fitness-blue text-fitness-blue"
                      />
                    ))}
                  </div>
